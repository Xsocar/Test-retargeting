 ...
 */
export declare type ContentItemElementsIndexer = ElementModels.IElement<any>;
...
export declare type PropertyNameResolver = (contentTypeCodename: string, elementCodename: string) => string;
