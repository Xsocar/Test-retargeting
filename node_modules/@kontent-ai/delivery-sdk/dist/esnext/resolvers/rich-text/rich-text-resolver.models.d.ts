...
export declare type IRichTextUrlResolver = (linkId: string, linkText: string, link?: ILink) => IRichTextUrlResult;
export declare type IRichTextImageResolver = (imageId: string, image?: IRichTextImage) => IRichTextImageResult;
export declare type IRichTextContentItemResolver = (itemCodename: string, contentItem?: IContentItem) => IRichTextContentItemResult;
export declare type IAsyncRichTextUrlResolver = (linkId: string, linkText: string, link?: ILink) => Promise<IRichTextUrlResult>;
export declare type IAsyncRichTextImageResolver = (imageId: string, image?: IRichTextImage) => Promise<IRichTextImageResult>;
export declare type IAsyncRichTextContentItemResolver = (itemCodename: string, contentItem?: IContentItem) => Promise<IRichTextContentItemResult>;
...
export declare type RichTextObjectDataType = 'linkedItem' | 'link' | 'image' | 'htmlElement' | 'root';
