 ...
 */
export declare class ParsedItemIndexReferenceWrapper {
    index: number;
...
export interface IParser<TParserOutput> {
    parse(html: string, mainRichTextElement: Elements.RichTextElement, resolvers: IParseResolvers, linkedItems: IContentItem[]): IParserResult<TParserOutput>;
}
export interface IAsyncParser<TParserOutput> {
    parseAsync(html: string, mainRichTextElement: Elements.RichTextElement, resolvers: IAsyncParseResolvers, linkedItems: IContentItem[]): Promise<IParserResult<TParserOutput>>;
}
