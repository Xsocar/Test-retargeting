...
import { IKontentListAllResponse, IKontentListResponse, IQueryConfig, SortOrder } from '../../models';
import { QueryService } from '../../services';
import { BaseListingQuery } from './base-listing-query.class';
export declare abstract class BaseItemListingQuery<TResponse extends IKontentListResponse, TAllResponse extends IKontentListAllResponse, TQueryConfig extends IQueryConfig, TContract> extends BaseListingQuery<TResponse, TAllResponse, TQueryConfig, TContract> {
