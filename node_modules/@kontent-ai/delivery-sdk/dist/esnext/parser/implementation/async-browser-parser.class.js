...
export class AsyncBrowserParser {
    parseAsync(html, mainRichTextElement, resolvers, linkedItems) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.parseInternalAsync(mainRichTextElement, resolvers, html, linkedItems, new ParsedItemIndexReferenceWrapper(0), null);
        });
    }
                ...
                for (let i = 0; i < htmlCollection.length; i++) {
                    ...
                    if (element.attributes &&
                        ...
                        if (!elementParent) {
                            ...
                            if (dataTypeAttribute.value === 'item') {
                                ...
                                // resolve linked item
                                yield resolvers.contentItemResolverAsync(parserHelper.convertToParserElement(element), linkItemContentObject.dataCodename, linkedItemIndex.index, parserHelper.getLinkedItem(linkedItems, linkItemContentObject.dataCodename));
                                // increment index
                    ...
                    // process links
                        ...
                        if (dataItemIdAttribute) {
                            ...
                            yield resolvers.urlResolverAsync(parserHelper.convertToParserElement(element), linkObject.dataItemId, linkText, parserHelper.tryGetLink(mainRichTextElement, linkedItems, linkObject.dataItemId));
                        }
                    }
                    // process images
                        ...
                        if (dataImageIdAttribute) {
                            ...
                            // resolve image
                            yield resolvers.imageResolverAsync(parserHelper.convertToParserElement(element), imageObj.imageId, parserHelper.tryGetImage(mainRichTextElement, linkedItems, imageObj.imageId));
                        }
                    }
                    else {
                        // process generic elements
                        yield resolvers.genericElementResolverAsync(parserHelper.convertToParserElement(element));
                    }
