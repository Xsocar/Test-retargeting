...
export declare namespace Elements {
    ...
    type MultipleChoiceElement = ElementModels.IElement<ElementModels.MultipleChoiceOption[]>;
    ...
    type RichTextElement = ElementModels.IElement<string> & {
        /**
         * Links
         */
        links: ILink[];
    ...
    type TaxonomyElement<TaxonomyCodename extends string = string> = ElementModels.IElement<ElementModels.TaxonomyTerm<TaxonomyCodename>[]> & {
        /**
         * Taxonomy group
         */
